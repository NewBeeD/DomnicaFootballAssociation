...
const PlayerProfile = () => {
  ...
  const mainStats = data ? [
    { label: 'Appearances', value: data.Appearances, icon: <PersonIcon />, color: 'primary' },
    { label: 'Goals', value: data.Goals, icon: <SoccerIcon />, color: 'success' },
    { label: 'Assists', value: data.Assists, icon: <TrendingUpIcon />, color: 'info' },
    { label: 'Yellow Cards', value: data.YellowCards, icon: <MilitaryTechIcon />, color: 'warning' },
    ...(data.RedCards ? [{ label: 'Red Cards', value: data.RedCards, icon: <MilitaryTechIcon />, color: 'error' }] : []),
    ...(data.MinutesPlayed ? [{ label: 'Minutes', value: data.MinutesPlayed, icon: <CalendarIcon />, color: 'secondary' }] : [])
  ] : []
